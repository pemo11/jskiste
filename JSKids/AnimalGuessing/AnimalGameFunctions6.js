...
var tiere = [
    ...
    {name:"Der Gorilla", img:"Gorilla.png", info:"Sehr groß, sehr kräfig, immer wütend, lebt im Urwald, meistens auf Bäumen"},
]
...
// Anmelden eines Players - gibt Avatar zurück
// Avatar hängt vom Status ab:
// 0 - Rookie
// 1 - > 10 Spiele
// 2 - > 25 Spiele
// 3 - > 50 Spiele
// 4 - > 100 Spiele
function anmeldenPlayer(player) {
    var player = {name:player, gameCount:0}
    return player
}